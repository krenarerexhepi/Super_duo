...
public class BookProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case BOOK_FULL:
                ...
                break;
            default:
                throw new UnsupportedOperationException(Resources.getSystem().getString(R.string.FailedToInsertRow) + uri);
        }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            default:
                throw new UnsupportedOperationException(Resources.getSystem().getString(R.string.UnknownUri) + uri);
        }
    }
        ...
        switch (match) {
            case BOOK: {
                ...
                if ( _id > 0 ){
                    ...
                    throw new android.database.SQLException(Resources.getSystem().getString(R.string.FailedToInsertRow) + uri);
                }
